// app variables
const apiKey = '148c2f43abb52bbd983463b61c509e6e';
let city = '';
...
let futureWeather = $('#future-weather');
let searchListCity = $('#search-city-history');
let currentCity = $('#current-city');


// searches the stored city (scity) to see if it exists already 
function find(c) {
...
$("#clear-history").on("click", clearClickHistory);
